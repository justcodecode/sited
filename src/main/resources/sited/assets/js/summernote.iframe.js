...
(function (factory) {
    ...
    var iframe = {
        document: function () {
            return $.summernote.iframe.contents().get(0);
        },
    ...
    var dom = (function () {
        ...
        var makeLayoutInfo = function (descendant) {
            ...
            if ($target.is('.note-editor, .note-air-editor')) {
                ...
                $editor = $(iframe.document()).find('#note-editor-' + list.last($target.attr('id').split('-')));
            }
        ...
        return {
            ...
            create: function (sc, so, ec, eo) {
                if (!arguments.length) { // from Browser Selection
                    if (agent.isW3CRangeSupport) {
                        var selection = iframe.document().getSelection();
                        if (selection.rangeCount === 0) {
                            return null;
                        ...
                        var textRange = iframe.document().selection.createRange();
    ...
    var Style = function () {
        ...
        this.current = function (rng, target) {
            ...
            styleInfo['font-bold'] = iframe.document().queryCommandState('bold') ? 'bold' : 'normal';
            styleInfo['font-italic'] = iframe.document().queryCommandState('italic') ? 'italic' : 'normal';
            styleInfo['font-underline'] = iframe.document().queryCommandState('underline') ? 'underline' : 'normal';
            styleInfo['font-strikethrough'] = iframe.document().queryCommandState('strikeThrough') ? 'strikethrough' : 'normal';
            styleInfo['font-superscript'] = iframe.document().queryCommandState('superscript') ? 'superscript' : 'normal';
            styleInfo['font-subscript'] = iframe.document().queryCommandState('subscript') ? 'subscript' : 'normal';
    ...
    var Editor = function (handler) {
        ...
        var triggerOnBeforeChange = function ($editable) {
            ...
            handler.bindCustomEvent(
                    $editable, $editable.data('callbacks'), 'before.command'
        ...
        var triggerOnChange = function ($editable) {
            // TODO find holder
            handler.bindCustomEvent(
                    $editable, $editable.data('callbacks'), 'change'
            ).call($editable.html(), $editable);
        };
        ...
        for (var idx = 0, len = commands.length; idx < len; idx++) {
            this[commands[idx]] = (function (sCmd) {
                return function ($editable, value) {
                    ...
                    iframe.document().execCommand(sCmd, false, value);
        ...
        this.formatBlock = function ($editable, tagName) {
            ...
            iframe.document().execCommand('FormatBlock', false, tagName);
            afterCommand($editable);
        };
        ...
        this.unlink = function ($editable) {
            ...
            if (rng.isOnAnchor()) {
                ...
                beforeCommand($editable);
                iframe.document().execCommand('unlink');
                afterCommand($editable);
            }
        };
        ...
        this.color = function ($editable, sObjColor) {
            ...
            if (foreColor) {
                iframe.document().execCommand('foreColor', false, foreColor);
            }
            if (backColor) {
                iframe.document().execCommand('backColor', false, backColor);
            }
        ...
        this.removeMedia = function ($editable, value, $target) {
            ...
            handler.bindCustomEvent(
                    $editable, $editable.data('callbacks'), 'media.delete'
    ...
    var Popover = function () {
        ...
        this.update = function ($popover, styleInfo, isAirMode) {
            ...
            if (styleInfo.anchor && $linkPopover.is(':hidden')) {
                ...
                pos = posFromPlaceholder(styleInfo.anchor, isAirMode);
                showPopover($linkPopover, {
            ...
            if (styleInfo.image) {
                pos = posFromPlaceholder(styleInfo.image, isAirMode);
                showPopover($imagePopover, {
                    left: pos.left,
                    top: pos.top + 50
                });
            } else {
            ...
            if (isAirMode && !styleInfo.range.isCollapsed()) {
                ...
                if (rect) {
                    ...
                    showPopover($airPopover, {
                        left: Math.max(bnd.left + bnd.width / 2 - PX_POPOVER_ARROW_OFFSET_X, 0) - offset.left,
                        top: bnd.top + bnd.height - offset.top
                    });
                    $linkPopover.hide();
                }
            } else {
    ...
    var EventHandler = function () {
        ...
        this.attach = function (layoutInfo, options) {
            ...
            if (!agent.isMSIE) {
                ...
                setTimeout(function () {
                    iframe.document().execCommand('styleWithCSS', 0, options.styleWithSpan);
                }, 0);
            }
